...
var withResponsiveSize = (0, _recompose.compose)((0, _recompose.withState)('screenSize', 'setScreenSize', function (_ref) {
  ...
  componentDidMount: function componentDidMount() {
    ...
    window.onresize = function () {
      var _props = _this.props,
          setScreenSize = _props.setScreenSize,
          getScreenSize = _props.getScreenSize;
  ...
  var setScreenSize = _ref3.setScreenSize,
      ...
      otherProps = _objectWithoutProperties(_ref3, ['setScreenSize', 'screenSize']);

  return otherProps;
}));

exports.withResponsiveSize = withResponsiveSize;
var useScreenSize = exports.useScreenSize = (0, _recompose.getContext)(responsizeContextType);

var useParseResponsiveObject = (0, _recompose.compose)(useScreenSize, (0, _recompose.mapProps)(function (_ref4) {
  var screenSize = _ref4.screenSize,
      otherProps = _objectWithoutProperties(_ref4, ['screenSize']);
...
exports.useParseResponsiveObject = useParseResponsiveObject;